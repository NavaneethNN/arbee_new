      ...
      <div className="container-section">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="flex flex-col gap-5">
            {/* Vision card */}
            <div
              className="flex-1 bg-gray-50 border border-gray-100 rounded-2xl p-6 hover:shadow-md transition-all duration-300 group"
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-base sm:text-lg font-bold text-gray-900">Our Vision</h3>
              </div>
            ...
            {/* Mission card */}
            <div
              className="flex-1 bg-brand rounded-2xl p-6 hover:shadow-xl transition-all duration-300"
              data-reveal="fade-right"
              data-delay="200"
            >
              <div className="flex items-center gap-3 mb-3">
          ...
          {/* Image */}
          <div
            className="relative rounded-2xl overflow-hidden shadow-xl min-h-[260px] sm:min-h-[320px] lg:min-h-0"
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-7">
              ...
              <p className="text-white/65 text-xs sm:text-sm mt-1.5">— Er. V. Ravichandran, Founder</p>
            </div>
          </div>
        </div>
      </div>
