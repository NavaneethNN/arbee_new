    ...
    <div style={{ paddingTop: "64px" }}>
      ...
      <section className="page-hero-lg">
        <div
          ...
          style={{ backgroundImage: `url('${R2}/images/about.jpg')` }}
        />
        ...
        <div className="relative z-10 container-section w-full py-12">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-black text-white leading-tight max-w-3xl mt-1">
        ...
        <div className="container-section">
          <div className="grid grid-cols-3 divide-x divide-gray-100">
            {stats.map((s) => {
              const Icon = s.icon;
              return (
                <div key={s.label} className="flex flex-col items-center py-8 px-3 gap-1.5 text-center">
                  <Icon size={22} className="text-brand-green" />
                  <span className="text-2xl sm:text-3xl font-black text-brand leading-none">{s.value}</span>
                  <span className="text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wide leading-tight">{s.label}</span>
                </div>
              );
            })}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div data-reveal="fade-right">
              ...
              <p className="text-gray-600 leading-relaxed mb-7 text-sm sm:text-base">
                ...
                we have forged with our clients.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[
                  ...
                  <div key={kp.label} className="bg-gray-50 border border-gray-100 rounded-xl p-4">
                    <div className="font-black text-brand text-base">{kp.label}</div>
            ...
            {/* Image — extra bottom space for the badge */}
            <div className="relative" data-reveal="fade-left">
              <div className="pb-10">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3]">
                  <Image
                    src={`${R2}/images/completed_cover.jpg`}
                ...
                <div className="absolute bottom-0 left-0 bg-brand text-white rounded-xl p-4 shadow-xl">
                  <div className="text-2xl font-black">2000</div>
                  <div className="text-[10px] text-white/70 font-semibold tracking-wide uppercase">Year Founded</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-section">
          ...
          <div className="max-w-2xl mx-auto" data-reveal="fade-up" data-delay="100">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              {/* Stacked on mobile, side-by-side on md+ */}
              <div className="flex flex-col md:grid md:grid-cols-5">
                <div className="md:col-span-2 bg-brand p-8 flex flex-col items-center justify-center gap-3 text-center">
                  <div className="w-20 h-20 rounded-full bg-white/20 flex items-center justify-center text-white font-black text-4xl border-4 border-white/30">
                    R
                  </div>
                  <div>
                    <div className="text-white font-black text-lg">Er. V. Ravichandran</div>
      ...
      <section className="section-padding bg-white">
        <div className="container-section">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="bg-brand rounded-2xl p-6 hover:shadow-md transition-shadow">
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-section">
          ...
          {/* Mobile: simple vertical list. md+: alternating layout */}
          <div className="relative max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {milestones.map((m, i) => (
                ...
                >
                  {/* Dot */}
                  <div className="absolute left-4 md:left-1/2 w-3.5 h-3.5 rounded-full bg-brand border-4 border-white shadow md:-translate-x-1/2 translate-y-2 flex-shrink-0 z-10" />
      ...
      <section className="section-padding bg-white">
        <div className="container-section">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { src: `${R2}/images/award.jpg`,  label: "Best Construction Quality" },
              { src: `${R2}/images/award2.jpg`, label: "Excellence in Design" },
              { src: `${R2}/images/award3.jpg`, label: "Client Satisfaction" },
              { src: `${R2}/images/award4.jpg`, label: "Industry Recognition" },
            ].map((a, i) => (
              <div
                key={a.label}
                className="group relative rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow aspect-square"
                data-reveal="zoom-in"
      ...
      <section className="bg-brand py-14">
        <div className="container-section text-center">
          ...
          <p className="text-purple-200 max-w-xl mx-auto mb-7 text-sm sm:text-base">
            Let&apos;s discuss your project and bring your construction vision to life.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href="/#contact" className="btn-green w-full sm:w-auto">
              Get Free Consultation <ArrowRight size={15} />
            </Link>
            <Link href="/projects/completed" className="btn-ghost-white w-full sm:w-auto">
              View Our Work
            </Link>
          </div>
        </div>
