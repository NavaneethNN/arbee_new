    ...
    <section id="services" className="section-padding bg-gray-50/60">
      <div className="container-section">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
          {services.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-bold text-gray-900 text-sm mb-1.5 group-hover:text-brand transition-colors">
                  {s.title}
                </h3>
          ...
          {/* CTA card */}
          <div
            className="bg-brand rounded-2xl p-5 flex flex-col justify-between card-hover"
            data-reveal="fade-up"
            data-delay="350"
          >
            <div>
              ...
              <h3 className="font-bold text-white text-sm mb-1.5">&amp; Many More</h3>
            ...
            <Link
              href="/#contact"
              className="mt-4 inline-flex items-center gap-1.5 text-brand-green font-bold text-sm hover:gap-2.5 transition-all"
            >
